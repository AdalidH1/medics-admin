...
export default function Nav({show}) {
  ...
  const activeLink = inactiveLink+' bg-highlight text-black rounded-l';
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-white p-4 fixed w-full pr-0 bg-primary h-full md:static md:w-auto transition-all"}>
